...
export interface APIInterface {
    ...
    // AVM calls
    callContractInteractive(options: BaseRequestOptions, callFile: string, identity: IWalletRecord, owner: IWalletRecord, funding: IWalletRecord, walletInfo: IValidatedWalletInfo, nofunding?: boolean): Promise<CommandResultInterface>;
